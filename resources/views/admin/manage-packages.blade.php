    ...
    <div class="container mx-auto mt-8 px-4">
        ...
        <div class="mb-6 ">
            <a href="{{ route('admin.dashboard') }}"
                class="inline-block px-4 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-800">
                Back to Dashboard
            </a> <a href="{{ route('admin.create-package') }}"
            ...
            <table class="min-w-full table-auto border-collapse border border-gray-300">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-sm font-semibold text-gray-600 border-b border-gray-300">Sender
                        </th>
                        <th class="px-6 py-3 text-left text-sm font-semibold text-gray-600 border-b border-gray-300">
                            Receiver</th>
                        <th class="px-6 py-3 text-left text-sm font-semibold text-gray-600 border-b border-gray-300">
                            Tracking Number</th>
                        <th class="px-6 py-3 text-left text-sm font-semibold text-gray-600 border-b border-gray-300">Status
                        </th>
                        <th class="px-6 py-3 text-left text-sm font-semibold text-gray-600 border-b border-gray-300">
                            Delivery Date</th>
                        <th class="px-6 py-3 text-left text-sm font-semibold text-gray-600 border-b border-gray-300">Actions
                        </th>
                    </tr>
                </thead>
                <tbody>
